# Workbench D: Fixtures, examples and experiments

Use Existing ZCode Goal on Homebase.

Own fixture generation and its semantic tests, prepared gallery assets/UI and isolated development experiments. Never read untouched evaluation labels.

Queue priority (choose first eligible, not necessarily first listed): pdf-g78, T21, T41, T42, T43, T44, T45.
...
## Volume boundaries
Finish/review pdf-g78 before allowing T21 to write its overlapping fixtures/public subtree. F13 actual ligatures/combining and F14 native-script fonts require real rights-pinned resources; mapping surrogates do not finish those mechanisms. E prepares supply-chain proposals and A merges approved asset/gate changes; you then generate fixtures without changing global original-fixture RIGHTS or frozen bytes. Use development data only for experiments. Evaluation labels stay under the independent custodian; reviewers execute held-out evaluation. Do not count an unexecuted experiment or missing resource as a successful rejection.
