# Workbench B: Native CLI and regression

Use Standalone Devin CLI / SWE-2.

Own the inspect/report/replay CLI, corpus/resume, reader profiles, immutable baselines, runnable upgrade example and native containment.

Queue priority (choose first eligible, not necessarily first listed): T30, T32, T33, T34, T35, T40.
